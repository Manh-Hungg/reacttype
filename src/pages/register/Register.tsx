...
import { registerApi, usersApi } from "../../services/room";
import { setUserInfoAction } from "../../store/action/userAction";
import { RootDispatch } from "../../store/config";
import { fetchRoomListAction } from "../../store/reducers/roomReducer";
...
export default function Register(): JSX.Element {
  ...
  const handleSubmit = async (event: any) => {
    ...
    // };
      ...
      const result = await usersApi(state); // tạo reducer mới
      console.log(result);
    // dispatch(setUserInfoAction(result.data.content)); // tạo reducer vs registerUserApiAction
  };
      ...
      <div className="container">
        <section className="wrapper">
          <div className="heading d-flex align-items-center">
            ...
            <h1 className="text text-large mx-auto">Đăng ký tài khoản</h1>
          </div>

          <form name="signin" className="form row" onSubmit={handleSubmit}>
            <div className="input-control col-6">
